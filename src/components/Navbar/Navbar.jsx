        ...
        <div className='bg-gradient-to-r from-purple-700 to-orange-500 flex items-center justify-between py-6 px-8 text-xl text-white'>
          ...
          <div className='flex gap-5'>
            <ul className='flex gap-8 text-xl items-center'>
              ...
              <li className={styles.li}>
                <NavLink to="/teammembers" className={({ isActive }) => isActive ? styles.active : undefined}>
                  Team Members
                </NavLink>
              </li>
              <li className={styles.li}>
                <NavLink to="/wfo" className={({ isActive }) => isActive ? styles.active : undefined}>
                  WFO/Leave
                </NavLink>
              </li>
              <li className={styles.li}>
                <NavLink to="/training" className={({ isActive }) => isActive ? styles.active : undefined}>
                  Training
                </NavLink>
              </li>
            </ul>
